...
const MODULES = [
  ...
  { emoji: '🎬', title: 'Introducciones', desc: 'El texto que abre cada pantalla y el video que lo acompaña.', href: '/admin/videos-intro', bg: 'linear-gradient(150deg,#F3E9EA,#FFFCF6)', border: '#EAD6D8' },
];
